...
Our objective is to release a new patched image within about 1 day: our CICD pipeline runs once a day to check for new upstream images on https://hub.docker.com/_/golang and creates a patched version of new images. We limit ourselves to new versions of Alpine and Debian, i.e., we will not support Debian and Alpine images that are end of life. However, we keep existing images in the container registry, i.e., existing images are immutable.
